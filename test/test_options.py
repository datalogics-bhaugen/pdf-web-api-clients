...
def test_invalid_output_type():
    ...
    Test(['-outputForm=spam', 'data/four_pages.pdf'], result).validate()

def test_invalid_pages():
    result = Result(ProcessCode.InvalidPage, StatusCode.BadRequest)
    Test(['-pages=spam', 'data/four_pages.pdf'], result).validate()
...
def test_lower_case():
    ...
    Test(['-opp', 'data/four_pages.pdf'], result).validate()

def test_missing_equals():
    result = Result(ProcessCode.InvalidSyntax, StatusCode.BadRequest)
    Test(['-pages', 'data/four_pages.pdf'], result).validate
