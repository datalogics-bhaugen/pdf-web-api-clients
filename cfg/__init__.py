...
class Config(dict):
    ...
    def initialize(self, filenames, default_dlenv='test'):
        ...
        for section_name in parser.sections():
            ...
            for name, value in parser.items(section_name):
                section[name] = value
        self.set_environment(Config.DLENV_FILENAME)
        self.set_dlenv(self.environment, default_dlenv)
    def set_dlenv(self, section, default_dlenv):
        dlenv = Config.DLENV
    ...
    def set_environment(self, dlenv_filename):
...
Configuration.initialize(file for file in cfg_files if is_cfg_file(file))
